...
// HealthCheckPlugin 定義了插件健康檢查的介面
// 職責: 提供插件健康狀態的檢查和報告功能
// AI_PLUGIN_TYPE: "health_check_plugin"
// AI_IMPL_PACKAGE: "detectviz-platform/internal/plugins/health"
// AI_IMPL_CONSTRUCTOR: "NewHealthCheckPlugin"
...
// HealthCheckCapablePlugin 表示支援健康檢查的插件
// 插件可以選擇性地實現此介面來提供健康檢查功能
type HealthCheckCapablePlugin interface {
	Plugin
	HealthCheckPlugin
}
